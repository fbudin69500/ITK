...
ObjectFactoryBase::SetStrictVersionChecking( bool value )
{
  ...
  m_Pimpl->m_StrictVersionChecking = value;
}
...
{
  itkInitGlobalsMacro(Pimpl);
  m_Pimpl->m_StrictVersionChecking = true;
}
...
{
  itkInitGlobalsMacro(Pimpl);
  m_Pimpl->m_StrictVersionChecking = false;
}
...
{
  itkInitGlobalsMacro(Pimpl);
  return m_Pimpl->m_StrictVersionChecking;
}
...
::RegisterFactory(ObjectFactoryBase *factory, InsertionPositionType where, size_t position)
{
  ...
  if ( strcmp( factory->GetITKSourceVersion(),
    ...
    {
    if ( m_Pimpl->m_StrictVersionChecking )
      {
...
ObjectFactoryBasePrivate * ObjectFactoryBase::m_Pimpl;
